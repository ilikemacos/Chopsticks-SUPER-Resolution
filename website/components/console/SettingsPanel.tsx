  ...
  return (
    <div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <p className="mb-3 font-display text-base font-semibold text-fg">Your data</p>
        ...
        <Card>
          <p className="mb-3 font-display text-base font-semibold text-fg">Desktop app</p>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <a
              ...
              className="inline-flex items-center rounded-lg border border-border px-4 py-2 text-sm font-medium text-fg transition-colors hover:border-primary/30"
            >
              Release notes
            </a>
          </div>
      ...
      <Card className="mt-4">
        <p className="mb-2 font-display text-base font-semibold text-fg">Honesty policy</p>
